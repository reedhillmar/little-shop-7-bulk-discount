...
def load_test_data
  #Merchants and items
    ...
    @merchant_3 = Merchant.create!(name: "Bobs Bakery")
      ...
      @item_5_m3 = @merchant_3.items.create!(name: "Rye", description: "Good for Sandwitch", unit_price: 3)
  ...
  # customers and invoices
    ...
    @customer_1 = Customer.create!(first_name: "Bob", last_name: "Dugles")
      ...
      @invoice_1_c1 = @customer_1.invoices.create!(status: 0)
        ...
        @invoice_item_1_i1_c1 = @invoice_1_c1.invoiceitems.create!(invoice_id: @invoice_1_c1.id, item_id: @item_1_m3.id, quantity: 2, unit_price: @item_1_m3.unit_price, staus: 0)
        @invoice_item_2_i1_c1 = @invoice_1_c1.invoiceitems.create!(invoice_id: @invoice_1_c1.id, item_id: @item_2_m3.id, quantity: 4, unit_price: @item_2_m3.unit_price, staus: 1)
        @invoice_item_3_i1_c1 = @invoice_1_c1.invoiceitems.create!(invoice_id: @invoice_1_c1.id, item_id: @item_3_m3.id, quantity: 1, unit_price: @item_3_m3.unit_price, staus: 0)
      @invoice_2_c1 = @customer_1.invoices.create!(status: 0)
        ...
        @invoice_item_1_i2_c1 = @invoice_2_c1.invoiceitems.create!(invoice_id: @invoice_2_c1.id, item_id: @item_1_m2.id, quantity: 2, unit_price: @item_1_m2.unit_price, staus: 2)
        @invoice_item_2_i2_c1 = @invoice_2_c1.invoiceitems.create!(invoice_id: @invoice_2_c1.id, item_id: @item_2_m2.id, quantity: 3, unit_price: @item_2_m2.unit_price, staus: 2)
        @invoice_item_3_i2_c1 = @invoice_2_c1.invoiceitems.create!(invoice_id: @invoice_2_c1.id, item_id: @item_3_m2.id, quantity: 4, unit_price: @item_3_m2.unit_price, staus: 2)
      @invoice_3_c1 = @customer_1.invoices.create!(status: 1)
        ...
        @invoice_item_1_i3_c1 = @invoice_3_c1.invoiceitems.create!(invoice_id: @invoice_3_c1.id, item_id: @item_1_m5.id, quantity: 200, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_4_c1 = @customer_1.invoices.create!(status: 1)
        ...
        @invoice_item_1_i4_c1 = @invoice_4_c1.invoiceitems.create!(invoice_id: @invoice_4_c1.id, item_id: @item_5_m6.id, quantity: 666, unit_price: @item_5_m6.unit_price, staus: 2)
      @invoice_5_c1 = @customer_1.invoices.create!(status: 2)
        ...
        @invoice_item_1_i5_c1 = @invoice_5_c1.invoiceitems.create!(invoice_id: @invoice_5_c1.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
    ...
    @customer_2 = Customer.create!(first_name: "Dan", last_name: "Smith")
      ...
      @invoice_1_c2 = @customer_2.invoices.create!(status: 1)
        ...
        @invoice_item_1_i1_c2 = @invoice_1_c2.invoiceitems.create!(invoice_id: @invoice_1_c2.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_2_c2 = @customer_2.invoices.create!(status: 2)
        ...
        @invoice_item_1_i2_c2 = @invoice_2_c2.invoiceitems.create!(invoice_id: @invoice_2_c2.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_3_c2 = @customer_2.invoices.create!(status: 2)
        ...
        @invoice_item_1_i3_c2 = @invoice_3_c2.invoiceitems.create!(invoice_id: @invoice_3_c2.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_4_c2 = @customer_2.invoices.create!(status: 2)
        ...
        @invoice_item_1_i4_c2 = @invoice_4_c2.invoiceitems.create!(invoice_id: @invoice_4_c2.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_5_c2 = @customer_2.invoices.create!(status: 1)
        ...
        @invoice_item_1_i5_c2 = @invoice_5_c2.invoiceitems.create!(invoice_id: @invoice_5_c2.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
    ...
    @customer_3 = Customer.create!(first_name: "Pam", last_name: "Sanders")
      ...
      @invoice_1_c3 = @customer_3.invoices.create!(status: 1)
        ...
        @invoice_item_1_i1_c3 = @invoice_1_c3.invoiceitems.create!(invoice_id: @invoice_1_c3.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_2_c3 = @customer_3.invoices.create!(status: 2)
        ...
        @invoice_item_1_i2_c3 = @invoice_2_c3.invoiceitems.create!(invoice_id: @invoice_2_c3.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_3_c3 = @customer_3.invoices.create!(status: 2)
        ...
        @invoice_item_1_i3_c3 = @invoice_3_c3.invoiceitems.create!(invoice_id: @invoice_3_c3.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_4_c3 = @customer_3.invoices.create!(status: 2)
        ...
        @invoice_item_1_i4_c3 = @invoice_4_c3.invoiceitems.create!(invoice_id: @invoice_4_c3.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_5_c3 = @customer_3.invoices.create!(status: 1)
        ...
        @invoice_item_1_i5_c3 = @invoice_5_c3.invoiceitems.create!(invoice_id: @invoice_5_c3.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
    ...
    @customer_4 = Customer.create!(first_name: "Sarah", last_name: "Tumlen")
      ...
      @invoice_1_c4 = @customer_4.invoices.create!(status: 1)
        ...
        @invoice_item_1_i1_c4 = @invoice_1_c4.invoiceitems.create!(invoice_id: @invoice_1_c4.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_2_c4 = @customer_4.invoices.create!(status: 1)
        ...
        @invoice_item_1_i2_c4 = @invoice_2_c4.invoiceitems.create!(invoice_id: @invoice_2_c4.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_3_c4 = @customer_4.invoices.create!(status: 0)
        ...
        @invoice_item_1_i3_c4 = @invoice_3_c4.invoiceitems.create!(invoice_id: @invoice_3_c4.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_4_c4 = @customer_4.invoices.create!(status: 0)
        ...
        @invoice_item_1_i4_c4 = @invoice_4_c4.invoiceitems.create!(invoice_id: @invoice_4_c4.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_5_c4 = @customer_4.invoices.create!(status: 2)
        ...
        @invoice_item_1_i5_c4 = @invoice_5_c4.invoiceitems.create!(invoice_id: @invoice_5_c4.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
    ...
    @customer_5 = Customer.create!(first_name: "Sal", last_name: "Garza")
      ...
      @invoice_1_c5 = @customer_5.invoices.create!(status: 2)
        ...
        @invoice_item_1_i1_c5 = @invoice_1_c5.invoiceitems.create!(invoice_id: @invoice_1_c5.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_2_c5 = @customer_5.invoices.create!(status: 1)
        ...
        @invoice_item_1_i2_c5 = @invoice_2_c5.invoiceitems.create!(invoice_id: @invoice_2_c5.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_3_c5 = @customer_5.invoices.create!(status: 2)
        ...
        @invoice_item_1_i3_c5 = @invoice_3_c5.invoiceitems.create!(invoice_id: @invoice_3_c5.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_4_c5 = @customer_5.invoices.create!(status: 0)
        ...
        @invoice_item_1_i4_c5 = @invoice_4_c5.invoiceitems.create!(invoice_id: @invoice_4_c5.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_5_c5 = @customer_5.invoices.create!(status: 1)
        ...
        @invoice_item_1_i5_c5 = @invoice_5_c5.invoiceitems.create!(invoice_id: @invoice_5_c5.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
    ...
    @customer_6 = Customer.create!(first_name: "Josh", last_name: "Posh")
      ...
      @invoice_1_c6 = @customer_6.invoices.create!(status: 1)
        ...
        @invoice_item_1_i1_c6 = @invoice_1_c6.invoiceitems.create!(invoice_id: @invoice_1_c6.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_2_c6 = @customer_6.invoices.create!(status: 0)
        ...
        @invoice_item_1_i2_c6 = @invoice_2_c6.invoiceitems.create!(invoice_id: @invoice_2_c6.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_3_c6 = @customer_6.invoices.create!(status: 0)
        ...
        @invoice_item_1_i3_c6 = @invoice_3_c6.invoiceitems.create!(invoice_id: @invoice_3_c6.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_4_c6 = @customer_6.invoices.create!(status: 2)
        ...
        @invoice_item_1_i4_c6 = @invoice_4_c6.invoiceitems.create!(invoice_id: @invoice_4_c6.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
      @invoice_5_c6 = @customer_6.invoices.create!(status: 1)
        ...
        @invoice_item_1_i5_c6 = @invoice_5_c6.invoiceitems.create!(invoice_id: @invoice_5_c6.id, item_id: @item_1_m5.id, quantity: 1, unit_price: @item_1_m5.unit_price, staus: 0)
